...
var ComponentOverlay = function (_a) {
    ...
    var onAddComponent = function (comp) { return function (e) {
        e.stopPropagation();
        setShowOption(false);
        onAdd(comp)();
    }; };
    return (react_1.default.createElement("div", { className: "component-overlay" },
        ...
        react_1.default.createElement("div", { className: "actions", onClick: function (e) { return e.stopPropagation(); } },
            react_1.default.createElement("span", { className: "drag-me" },
                react_1.default.createElement("img", { src: require('./images/drag.png'), alt: "" })),
            react_1.default.createElement("span", { onClick: function () { return setShowOption(!showOption); } },
                react_1.default.createElement("img", { src: require('./images/add.png'), alt: "" })),
            react_1.default.createElement("span", { onClick: onRemove(content) },
                react_1.default.createElement("img", { src: require('./images/close.png'), alt: "" }))),
