...
var ComponentOverlay = function (_a) {
    var component = _a.component, content = _a.content, onRemove = _a.onRemove, onAdd = _a.onAdd, isActive = _a.isActive;
    ...
    return (react_1.default.createElement("div", { className: "component-overlay" },
        react_1.default.createElement(component.render, { attributes: content.attributes, isActive: isActive }),
