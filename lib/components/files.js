...
var File = function (_a) {
    ...
    if (!file) {
        return (react_1.default.createElement(react_filepicker_1.default, { apikey: process.env.REACT_APP_FILESTACK_API_KEY, onSuccess: onSuccess, buttonText: "Upload" }));
    }
    return (react_1.default.createElement("div", { className: "file-wrapper" },
        react_1.default.createElement("img", { src: require('../images/file.png'), alt: "" }),
