...
var Image = function (_a) {
    ...
    if (!image || isActive) {
        return (react_1.default.createElement(react_filepicker_1.default, { apikey: fileStackApi, onSuccess: onSuccess, buttonText: "Upload", buttonClass: "upload-file-button " + (!!image && 'hide-button'), options: {
                mimetypes: ['image/*'],
            } }));
    }
