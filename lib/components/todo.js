...
var CheckItem = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "checkbox-wrapper" },
        ...
        react_1.default.createElement("input", { type: "text", value: item.val, className: "sc-input-text", placeholder: "type check item", onKeyUp: handleKeyDown(item), onChange: onChange(item) })));
};
